    ...
    <motion.header ref={headerRef} className="fixed top-0 left-0 right-0 z-40 w-full">
      ...
      >
        <Link href="/" className="relative z-20 mr-4 flex items-center px-2 py-1">
          <span className={`text-2xl font-bold transition-colors ${visible ? "text-primary" : "text-white"}`}>LUZ</span>
        </Link>
            ...
            <div key={`nav-item-${idx}`} className="relative">
              <Link
                ...
                className={`relative px-4 py-2 rounded-full transition-all duration-300 cursor-pointer ${
                  visible ? "text-black hover:text-white" : "text-white"
      ...
      >
        <div className="flex w-full flex-row items-center justify-between">
          <Link href="/" className="flex items-center">
            <span className={`text-2xl font-bold transition-colors ${visible ? "text-primary" : "text-white"}`}>
              LUZ
            </span>
          </Link>

          <button
            className={`p-2 rounded-full cursor-pointer ${visible ? "text-black" : "text-white"}`}
